...
{
  setWindowTitle(tr("About Minusery Dolphin"));
  ...
  const QString text =
      QStringLiteral(R"(
<p style='font-size:34pt; font-weight:400;'>Brawl Minus Dolphin</p>
...
<p>
Built on Dolphin 2606a. %CHECK_FOR_UPDATES%: <a href='https://brawlminus.net'>brawlminus.net.</a>
</p>
